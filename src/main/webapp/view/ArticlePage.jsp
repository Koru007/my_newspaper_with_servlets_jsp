...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/view/style/ArticlePage.css">
</head>

<body>
<div id="side_text" class="col-md-2">
    <h1 class="live"><strong>LIVE NEWS</strong></h1>
...
<div id="container" class="col-md-8">
    ...
    <div id="content">
        <div id="middle_part_container">
            <div id="text">
                    <b:set value="${articles}" var="directed"/>
                <h1 class="live" >${directed.title}</h1>
                <p id="article">${directed.content}</p>
        </div>
            <div>
                <div class="polaroid img4">
                    <img src="${directed.imgUrl}" class="middleNews">
                </div>
            </div>
        </div>
